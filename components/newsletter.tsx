...
export default function Newsletter({
  ...
  subtitle = "Stay updated with our latest products, offers, and fashion tips.",
  backgroundImage,
}: NewsletterProps) {
  ...
  return (
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-900 rounded-2xl shadow-sm p-8 md:p-12">
          <motion.div
