...
const defaultValues: FormValues = {
  ...
  description: "Shop our summer collection and enjoy exclusive discounts on selected items.",
  ctaText: "Shop Now",
  ctaLink: "/products",
  ...
  size: "medium",
  dismissible: true,
  imageSrc: "/modern-summer-fashion.png",
}
...
export default function PromoBanner1Page() {
  ...
  function onSubmit(data: FormValues) {
    try {
      ...
      localStorage.setItem("promo-banner-1-settings", JSON.stringify(data))
  ...
  return (
    <div className="container mx-auto py-10 px-4 max-w-5xl">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-bold">Promotional Banner 1</h1>
          <p className="text-muted-foreground mt-2">
            Customize the first promotional banner that appears on your home page
          </p>
        </div>
      </div>
